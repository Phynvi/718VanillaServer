...
/**
 * Holds the return codes that can be sent to the client when attempting to
 * login.
 */
public enum LoginResponsePacket {
	...
	/**
	 * When the player switch's worlds, and tries to log back in too quick.
	 */
	SWITCHING_WORLDS(21),
	...
	/**
	 * Constructs a new {@code LoginResponsePacket} {@code Object}.
	 * 
	 * @param value
	 *            The value.
	 */
	private LoginResponsePacket(int value) {
